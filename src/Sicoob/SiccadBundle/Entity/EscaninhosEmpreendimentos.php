...
/**
 * Sicoob\SiccadBundle\Entity\EscaninhosEmpreendimentos
 *
 * @ORM\Table(name="escaninhos_empreendimentos")
 * @ORM\Entity
 */
class EscaninhosEmpreendimentos
{
    /**
     * @var integer $id
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="escaninhos_empreendimentos_id_seq", allocationSize="1", initialValue="1")
     */
    private $id;
